    ...
    <footer className="bg-black text-white pt-16 pb-8">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            <a href="#" className="text-2xl font-bold mb-4 inline-block text-primary">Attivo</a>
            <p className="text-gray-400 mb-4">
              Track, analyze, and optimize your fitness journey with our comprehensive activity tracking platform.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#activities" className="text-gray-400 hover:text-primary transition-colors">Activities</a></li>
              <li><a href="#performance" className="text-gray-400 hover:text-primary transition-colors">Performance</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">123 Fitness Avenue, Health City, HC 10001</span>
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-400">info@attivo.com</span>
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-gray-800 pt-8">
          <p className="text-center text-gray-500">
            © {new Date().getFullYear()} Attivo. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
