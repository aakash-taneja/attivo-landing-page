  ...
  return (
    <section id="features" className="section bg-secondary">
      <div className="container">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Best Features We Offer For You</h2>
          <p className="text-gray-300 max-w-2xl">Discover the powerful features that make Sportivo the best choice for tracking and analyzing your fitness journey.</p>
        </motion.div>
