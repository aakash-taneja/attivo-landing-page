...
const OptimizeActivitiesSection = () => {
  ...
  return (
    <section id="optimize" className="section bg-secondary" ref={ref}>
      <div className="container">
        <div className="flex flex-col-reverse md:flex-row items-center gap-12">
          <div className="md:w-1/2">
            ...
            >
              Integrate with your favorite devices and apps to consolidate all
              your fitness data. Get personalized recommendations to optimize
              your workouts and achieve better results.
            </motion.p>
